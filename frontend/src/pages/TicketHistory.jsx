...
function TicketHistory() {
  ...
  const handleCancel = async (ticketId) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/tickets/${ticketId}/cancel`,
        {
          method: "PATCH",
          credentials: "include",
        },
  ...
  const renderSortIcon = (key) => {
    ...
    if (!isActive) {
      return (
        <i
          className="bi bi-arrow-down-up sort-indicator sort-indicator-muted"
          aria-hidden="true"
        />
      );
    }
          ...
          <>
            ...
            <div className="office-pagination">
              ...
              <button
                ...
                className="btn btn-neutral"
                disabled={
                  loading || currentPage >= totalPages || tickets.length === 0
                }
                onClick={() =>
                  setPage((prev) =>
              ...
              >
                ...
                >
                  <div className="modal-header">
                    <div>
                      ...
                      <h2 id="ticket-details-title">
                        {selectedTicket.request_id || "Travel Request"}
                      </h2>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="ticket-details-summary">
                    ...
                    <span
                      className={`status-badge status-${(selectedTicket.status || "pending").toLowerCase()}`}
                    >
                  ...
                  <section className="ticket-details-section">
                    ...
                    <dl className="ticket-details-grid">
                      <div className="ticket-details-item">
                        ...
                        <dd>
                          {formatBool(selectedTicket.hotel_accommodation)}
                        </dd>
                      </div>
                      <div className="ticket-details-item">
